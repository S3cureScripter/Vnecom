...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    const XML_PATH_CUSTOMER_NEW_ORDER_MESSAGE_BY_SHIPPING_METHOD = 'vsms/customer/new_order_by_shipping_method';

    const XML_PATH_CUSTOMER_NEW_INVOICE_MESSAGE_BY_PAYMENT_METHOD = 'vsms/customer/new_invoice_by_payment_method';
    const XML_PATH_CUSTOMER_NEW_INVOICE_MESSAGE_BY_SHIPPING_METHOD = 'vsms/customer/new_invoice_by_shipping_method';
    ...
    const XML_PATH_CUSTOMER_NEW_SHIPMENT_MESSAGE_BY_PAYMENT_METHOD = 'vsms/customer/new_shipment_by_payment_method';
    const XML_PATH_CUSTOMER_NEW_CREDITMEMO_MESSAGE_BY_SHIPPING_METHOD = 'vsms/customer/new_creditmemo_by_shipping_method';
    const XML_PATH_CUSTOMER_NEW_CREDITMEMO_MESSAGE_BY_PAYMENT_METHOD = 'vsms/customer/new_creditmemo_by_payment_method';
     ...
     * @var array
     */
    protected $shippingMethodUseBilling;
     ...
     * @param array $shippingMethodUseBilling
     */
    public function __construct(
        ...
        array $smsGateways = [],
        array $otpParameters =[],
        array $shippingMethodUseBilling = []
    ) {
        ...
        $this->shippingMethodUseBilling = $shippingMethodUseBilling;
    ...
    public function getConfigTypeLogin($storeId = null){
        return $this->scopeConfig->getValue(self::XML_PATH_ENABLE_OTP_LOGIN, ScopeInterface::SCOPE_STORE, $storeId);
    }
    ...
    public function getNewOrderMessagesByShipping($storeId = null){
        return $this->scopeConfig->getValue(self::XML_PATH_CUSTOMER_NEW_ORDER_MESSAGE_BY_SHIPPING_METHOD, ScopeInterface::SCOPE_STORE, $storeId);
    }
    ...
    public function getNewInvoiceMessagesByPayment($storeId = null){
        return $this->scopeConfig->getValue(self::XML_PATH_CUSTOMER_NEW_INVOICE_MESSAGE_BY_PAYMENT_METHOD, ScopeInterface::SCOPE_STORE, $storeId);
    }
    ...
    public function getNewInvoiceMessagesByShipping($storeId = null){
        return $this->scopeConfig->getValue(self::XML_PATH_CUSTOMER_NEW_INVOICE_MESSAGE_BY_SHIPPING_METHOD, ScopeInterface::SCOPE_STORE, $storeId);
    }
    ...
    public function getNewShipmentMessagesByPayment($storeId = null){
        return $this->scopeConfig->getValue(self::XML_PATH_CUSTOMER_NEW_SHIPMENT_MESSAGE_BY_PAYMENT_METHOD, ScopeInterface::SCOPE_STORE, $storeId);
    }
    ...
    public function getNewCreditMemoMessagesByShipping($storeId = null){
        return $this->scopeConfig->getValue(self::XML_PATH_CUSTOMER_NEW_CREDITMEMO_MESSAGE_BY_SHIPPING_METHOD, ScopeInterface::SCOPE_STORE, $storeId);
    }
    ...
    public function getNewCreditMemoMessagesByPayment($storeId = null){
        return $this->scopeConfig->getValue(self::XML_PATH_CUSTOMER_NEW_CREDITMEMO_MESSAGE_BY_PAYMENT_METHOD, ScopeInterface::SCOPE_STORE, $storeId);
    }
